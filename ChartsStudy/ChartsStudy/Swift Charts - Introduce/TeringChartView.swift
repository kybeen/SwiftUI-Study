        ...
        VStack {
            ...
            Chart {
                ForEach(weekSwingData) { element in
                    ...
                    .cornerRadius(5)
                    .foregroundStyle(.linearGradient(colors: [Color(uiColor: UIColor(hex: 0x3FF23D)), .black], startPoint: .init(x: 0.5, y: 0.0), endPoint: .init(x: 0.5, y: 1))) // 초록
                    ...
                    .cornerRadius(5)
                    .foregroundStyle(.linearGradient(colors: [Color(uiColor: UIColor(hex: 0x3AE0F1)), .black], startPoint: .init(x: 0.5, y: 0), endPoint: .init(x: 0.5, y: 1))) // 파랑
                }
...
//    .init(swingDataType: "total", data: totalData),
//    .init(swingDataType: "perfect", data: perfectData)
//]
//
//struct TeringChartView: View {
//    @State var period: Period = .week
...
//            }
//        }
//        totalSwingAverage = totalSum / weekPerSwingDataType.count
//        perfectSwingAverage = perfectSum / weekPerSwingDataType.count
//    }
//    var body: some View {
//        VStack {
//            Picker("Period", selection: $period.animation(.easeInOut)) {
